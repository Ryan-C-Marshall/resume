...
\usepackage[top=15pt,left=1cm,right=1cm,bottom=1cm]{geometry}
\usepackage{graphicx}
\usepackage{multirow}
...
\definecolor{anti-flashwhite}{rgb}{0.75, 0.75, 0.75}

\setlength{\parindent}{0cm}  % no indents on paragraphs
\setlength{\tabcolsep}{0em}  % no padding in tables
...
\node[anchor=north east,xshift=-15pt,yshift=-18pt]{\includegraphics[width=200pt,height=120pt]{Resume Background.png}};
\end{tikzpicture}
...
\begin{tabular}{p{0.7\linewidth}p{0.3\linewidth}}
    ...
    \\
    ryan.chris.marshall@gmail.com \textbullet\  (431) 777 7850 & % empty
    \\
...
% Education section   % NOTE: this hbox is overfull because I have the @hspace{0.05linewidth}| to have the seperator between education and skills
\begin{minipage}[t]{0.48\textwidth}
\Large \textbf{Education}
    \renewcommand{\arraystretch}{1.25}
    \arrayrulecolor{anti-flashwhite} % dunno why this works here for vertical lines defined above, but it does
...
% \node[xshift=167pt,yshift=93pt]{\includegraphics[width=220px]{arrow.png}};
\node[xshift=-12pt,yshift=85pt]{\includegraphics[width=-120px]{arrow.png}};
\end{tikzpicture}
...
\end{minipage}
\hspace{0.01\linewidth} % put space between the sections
\begin{minipage}[t]{0.39\linewidth}
\large \textbf{Personal Highlights} \vspace{0.3\normalbaselineskip}\\
\large Programming Projects (see github) \footnotesize \\\normalsize
$\cdot$ Statistics library (with graphs, analysis)\\
$\cdot$ Neural network AI to play Flappy Bird\\
$\cdot$ Many other miscellaneous projects\\
$\cdot$ Various games \& accompanying calculators or AIs/neural networks to play them)\\
$\cdot$ Program to help DQ employees train \\
$\cdot$ These projects required: \vspace{-0.5\baselineskip}
\begin{itemize}{\setlength{\itemsep}{-5pt}
    \item OOP algorithms and data structures
    \item UI building from scratch, with custom modules (buttons, sliders, etc)
    \item Building robust code to withstand use from the general public
}\end{itemize} \hrule\vspace{0.3\baselineskip}
\large Awards and Achievements \footnotesize \\\normalsize
$\cdot$ Schulich Leaders Scholarship\\
$\cdot$ CAP Physics Exam: 13\textsuperscript{th} nationally / 1\textsuperscript{st} provincially\\
$\cdot$ Pascal Math Competition: 1\textsuperscript{st} provincially\\
$\cdot$Toyota Scholarship for Engineers\\
$\cdot$Queen Elizabeth II Scholarship\\
$\cdot$Several other awards for academic excellence / character
